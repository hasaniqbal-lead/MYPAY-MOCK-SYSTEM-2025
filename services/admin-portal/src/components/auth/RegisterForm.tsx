          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Letters only, no spaces. Your login email will be: <span className="font-mono text-mypay-green">{formData.username || 'username'}@{brandConfig.supportEmail.split('@')[1] || 'settlix.net'}</span>
              </p>
            </div>
