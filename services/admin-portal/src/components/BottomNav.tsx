...
import { LayoutDashboard, Users, CreditCard, Wallet, MoreHorizontal } from 'lucide-react'
...
export default function BottomNav({ onMoreClick }: { onMoreClick: () => void }) {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 safe-bottom">
