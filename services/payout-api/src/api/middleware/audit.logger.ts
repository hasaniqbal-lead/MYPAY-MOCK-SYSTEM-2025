 ...
 */
export function auditRequestLogger(req: MerchantRequest, res: Response, next: NextFunction): void {
 ...
 */
export function auditResponseLogger(req: MerchantRequest, res: Response, next: NextFunction): void {
 ...
 */
export function logAuthAttempt(success: boolean, apiKey?: string, reason?: string, ip?: string): void {
  const authLog = {
    timestamp: new Date().toISOString(),
